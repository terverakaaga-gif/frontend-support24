...
const TimesheetsManagement: React.FC = () => {
  ...
  const handleFilterChange = (key: keyof TimesheetClientFilters, value: any) => {
    setFilters(prev => ({
      ...prev,
  ...
  const hasActiveFilters = filters.status || filters.participantId || filters.search || 
    ...
    return (
      <div className="flex items-center justify-between px-2">
        <div className="text-sm text-muted-foreground">
          ...
          {Math.min(page * filters.limit!, timesheetData.pagination.totalResults)} of{' '}
          {timesheetData.pagination.totalResults} timesheets
        </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-2xl font-bold">{timesheetData.summary.totalTimesheets}</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-2xl font-bold">{Math.round(timesheetData.summary.totalHours)}</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-2xl font-bold">{formatCurrency(timesheetData.summary.totalAmount)}</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-2xl font-bold">{timesheetData.summary.pendingCount}</p>
      ...
      {showFilters && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Filter timesheets by various criteria</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => handleFilterChange('participantId', value)}
                >
                  <SelectTrigger>
                    ...
                    >
                      <div className="flex items-center space-x-1">
                        ...
                        {filters.sortField === 'scheduledStartTime' && (
                          <ChevronDown className={`h-4 w-4 ${filters.sortDirection === 'asc' ? 'rotate-180' : ''}`} />
                        )}
                      </div>
                    </TableHead>
                      ...
                      <TableRow key={timesheet._id}>
                        <TableCell className="font-medium">
                          <div className="flex flex-col">
                            <span className="font-mono">{timesheet.shiftIdRef}</span>
                        ...
                        <TableCell>
                          <div className="flex flex-col">
                            <span className="font-medium">{formatDateShort(timesheet.scheduledStartTime)}</span>
