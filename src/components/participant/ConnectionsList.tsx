...
const mockConnections: SupportWorker[] = [
  ...
  export function ConnectionsList() {
    const [connections] = useState<SupportWorker[]>(mockConnections);
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>View and interact with your connected support workers</CardDescription>
            </div>
                  ...
                  <div className="flex flex-col h-full">
                    <div className="flex items-start p-4 gap-4">
                      <Avatar className="h-16 w-16">
                        ...
                        <AvatarFallback className="text-lg">{connection.firstName.charAt(0)}{connection.lastName.charAt(0)}</AvatarFallback>
                      </Avatar>
                      <div className="flex-1">
                        <h3 className="font-semibold text-lg">{getUserFullName(connection)}</h3>
                    ...
                    <div className="p-4 pt-0">
                      ...
                      <div className="text-sm">
                        <div className="mt-1">
                          <span className="font-medium">Languages:</span> {connection.languages ? connection.languages.join(", ") : "Not specified"}
                        </div>
                        <div className="mt-1">
                          <span className="font-medium">Base Rate:</span> ${connection.hourlyRate.baseRate}/hr
                        </div>
                      </div>
                    </div>
