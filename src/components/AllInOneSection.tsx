...
export const AllInOneSection: React.FC<AllInOneSectionProps> = ({
  ...
  return (
    <section
      className={`relative py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 lg:px-12 bg-[#05030B] lg:pt-48 pt-20 ${className}`}
    >
      {/* Decorative Shadows */}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-800/80 rounded-full mb-6 sm:mb-8">
            ...
            <span className="text-white text-sm font-montserrat-medium">
              Everything You Need
            </span>
          </div>
