...
export const StepExperience = React.memo(
  ({ defaultValues, onNext, onBack }: Props) => {
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <div className="space-y-2">
            <h2 className="text-xl font-montserrat-bold text-primary-600">
              Work Experience
            </h2>
          ...
          <div className="space-y-6">
            {fields.map((field, index) => {
              ...
              return (
                <div
                  key={field.id}
                  className="bg-gray-50/50 p-4 rounded-xl border border-gray-100 space-y-4"
                >
                  <div className="flex justify-between items-center">
                    <h4 className="font-montserrat-semibold text-sm italic text-gray-700">
                      Experience {index + 1}
                    </h4>
                    {fields.length > 1 && (
                      <button
