...
export default function WorkforceCard({
  ...
  return (
    <Card className="p-6 flex flex-col items-center border border-gray-200 shadow-sm hover:shadow-md transition-all bg-white rounded-xl relative">
      ...
      <p className="text-gray-500 text-sm font-montserrat-medium mb-3">{worker.role}</p>
        ...
        {isVetted ? (
          ...
          <>
            <Button
              ...
              className="flex-1 text-primary-600 border-primary-600 hover:bg-primary-50 py-2.5 h-auto text-sm font-montserrat-bold rounded-lg"
            >
              Assign Shift
            </Button>
            <Button
          ...
          <Button
            ...
            className="w-full text-primary-600 border-primary-600 py-2.5 h-auto text-sm font-montserrat-bold rounded-lg"
          >
            Start Onboarding
          </Button>
        )}
