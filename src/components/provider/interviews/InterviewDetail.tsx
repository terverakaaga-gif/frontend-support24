    ...
    <div className="flex flex-col gap-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mt-1">
          <span className="font-montserrat-medium text-gray-900">{session.candidateName}</span>
          <span>|</span>
        ...
        <div className="lg:col-span-7 flex flex-col h-full">
          <div className={cn("relative w-full aspect-video bg-black rounded-xl overflow-hidden shadow-lg group", RADIUS.xl)}>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
              ...
              <div className="flex justify-between text-white text-xs font-montserrat-medium">
                <span>0:00</span>
                <span>1:00</span>
              </div>
            </div>
                ...
                {session.transcript.map((line, idx) => (
                  <div key={idx} className={cn(
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {line.speaker === 'Interviewer' && <span className="text-xs font-montserrat-bold text-gray-700">Interviewer</span>}
                    </div>
            ...
            {activeTab === 'report' && (
              <div className="space-y-8">
                  ...
                  <div className="space-y-3">
                    {Object.entries(session.aiReport.scores).map(([key, value]) => (
                      <div key={key} className="flex items-center justify-between text-sm">
                        <span className="capitalize text-gray-700 font-montserrat-medium">
                          {key.replace(/([A-Z])/g, ' $1').trim()}
                        </span>
                        <span className="font-montserrat-bold text-gray-900">{value}/10</span>
                      </div>
                    ))}
                  </div>
                </section>
                ...
                <div className="bg-blue-50 p-4 rounded-lg flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-blue-600 font-montserrat-bold uppercase">Match Score</p>
