  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.userId ) {
        ...
        const errorMessage = "Failed to resend instructions";
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 font-montserrat-semibold">
                  We've sent verification instructions to {email}
                </p>
              </div>
              <Button
                asChild
            ...
            <>
              ...
              <div className="text-center">
                ...
                <p className="font-montserrat-semibold text-gray-600">
                  ...
                  <br />
                  in the next step to verify your email
                </p>
              </div>
