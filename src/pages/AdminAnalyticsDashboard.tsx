...
export default function AdminAnalyticsDashboard() {
  ...
  } = useGetDashboardOverview(dateRange, showComparison, activeTab === 'overview');

  const {
    data: userData,
    isLoading: isLoadingUsers,
  } = useGetUserAnalytics(dateRange, activeTab === 'users');
    ...
    <div className="p-6 space-y-8">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <ExportButton
            dateRange={dateRange}
            isLoading={isLoadingOverview || isLoadingUsers || isLoadingFinancial || isLoadingPlatform}
          />
        </div>
      </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              <div className="space-y-4">
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium">Average Shift Value</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="text-2xl font-bold">
        ...
        <TabsContent value="financial" className="space-y-6">
          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium">Quarterly Projected</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-sm font-medium">Cancelled Shifts</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="text-2xl font-bold">
                        {isLoadingPlatform ? "Loading..." : 
            ...
            >
              <div className="space-y-4">
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-medium">Avg Workers per Org</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {isLoadingPlatform ? "Loading..." : 
