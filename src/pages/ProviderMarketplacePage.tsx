      ...
      <GeneralHeader
        ...
        rightComponent={
          <div className="relative flex-grow md:w-80">
            ...
            <Input
              placeholder="Search...."
              className="pl-10 h-11 rounded-full bg-gray-50 border-gray-200 focus:ring-blue-500"
              value={searchQuery}
      ...
      <div className={cn(CONTAINER_PADDING)}>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            <span>Showing</span>
            <select className="border border-gray-300 rounded-md p-1 bg-white focus:outline-none focus:ring-1 focus:ring-blue-500">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="w-8 h-8 flex items-center justify-center bg-blue-700 text-white rounded">
              1
            </button>
