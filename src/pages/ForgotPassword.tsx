  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success && response.data?.userId) {
        ...
        navigate(`/reset-password?userId=${response.data.userId}&email=${encodeURIComponent(email)}`);
      } else {
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-8">
        ...
        >
              ...
              {isSuccess ? (
                ...
                >
                  ...
                  <div className="space-y-3">
                    <Button asChild className="w-full bg-[#2195F2] hover:bg-[#1976D2]">
                      <Link to="/login">
          ...
          <div className="text-center text-sm text-gray-600">
            ...
            <Link to="/register" className="text-[#2195F2] hover:text-[#1976D2] font-medium">
              Sign up
            </Link>
          </div>
        </motion.div>
