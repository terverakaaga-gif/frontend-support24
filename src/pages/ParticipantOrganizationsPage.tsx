		...
		<div className="p-6 space-y-8">
			...
			<div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
				<div className="space-y-1">
					<h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-[#008CFF] to-blue-600 bg-clip-text text-transparent">
						My Organizations
					</h1>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
				...
				<Card className="relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
					<div className="absolute inset-0 bg-gradient-to-br from-[#008CFF]/5 to-blue-600/10" />
					<CardContent className="p-6 relative">
						<div className="flex items-center justify-between">
							<div className="space-y-1">
								<p className="text-sm font-medium text-[#008CFF]">
									My Organizations
								</p>
								<p className="text-3xl font-bold text-gray-900 group-hover:text-[#008CFF] transition-colors">
									{stats.totalOrganizations}
								</p>
								<p className="text-xs text-gray-500">Created & Managed</p>
							</div>
							<div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#008CFF] to-blue-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
					...
					<CardContent className="p-12 text-center">
						...
						<p className="text-gray-600 max-w-md mx-auto mb-6">
							{searchTerm
								...
								: "You don't have unknown organizations yet. Create your first organization to start managing support workers."}
						</p>
						{!searchTerm && (
							<Button
								className="bg-[#008CFF] hover:bg-[#008CFF]/90"
						...
						>
							<CardHeader className="pb-4">
								<div className="flex items-start justify-between">
									<div className="flex items-center gap-3">
										<div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#008CFF] to-blue-600 flex items-center justify-center">
											<Building className="w-6 h-6 text-white" />
										</div>
										<div>
											<CardTitle className="text-lg font-semibold text-gray-900 group-hover:text-[#008CFF] transition-colors">
												{organization.name}
											</CardTitle>
							...
							<CardContent className="space-y-4">
									...
									{organization.workers.length === 0 ? (
										<div className="text-center py-6 bg-gray-50 rounded-lg">
											...
											<Button
												variant="ghost"
												size="sm"
												className="mt-2 text-[#008CFF] hover:text-[#008CFF]/80"
												onClick={() => {
										...
										<div className="space-y-3 max-h-48 overflow-y-auto">
											{organization.workers.slice(0, 3).map((worker) => (
												<div
													key={worker._id}
													className="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg hover:border-[#008CFF]/20 transition-colors"
												>
													<div className="flex items-center gap-3">
								...
								<div className="flex gap-2 pt-4 border-t">
									<Button
										variant="outline"
										size="sm"
										className="flex-1 border-[#008CFF]/20 text-[#008CFF] hover:bg-[#008CFF]/10"
										onClick={() =>
									...
									<Button
										size="sm"
										className="flex-1 bg-[#008CFF] hover:bg-[#008CFF]/90"
									>
										<UserPlus className="w-4 h-4 mr-2" />
										Invite Workers
									</Button>
